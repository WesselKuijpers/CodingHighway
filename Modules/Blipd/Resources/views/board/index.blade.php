                    ...
                    @foreach($planning->lessons->where('state_id', $state->id) as $lessonCard)
                        <div class="card blipd-card m-3" id="lcard{{$lessonCard->id}}" draggable="true">
                            <div class="card-body">
                                ...
                                {{--<p class="pl-3">Punten: 5</p>--}}
                                <button class="btn btn-success ml-3">Bl</button>
                                <button class="btn btn-success ml-1">IP</button>
                                <button class="btn btn-success ml-1">D</button>
                                <button class="btn btn-success ml-1">F</button>
                            </div>
                        </div>
                    @endforeach
                </div>
                    ...
                    @foreach($planning->exercises->where('state_id', $state->id) as $exerciseCard)
                        <div class="card blipd-card m-3" id="ecard{{$exerciseCard->id}}" draggable="true">
                            <div class="card-body">
                                ...
                                <span class="blipd-points-badge bg-info text-white">5 punten</span>
                                <button class="btn btn-success ml-2">Bl</button>
                                <button class="btn btn-success">IP</button>
