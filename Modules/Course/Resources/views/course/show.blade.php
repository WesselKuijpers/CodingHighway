...
@section('content')
    <div class="row">
        @if($startResult->count() != 1 && !Auth::user()->hasPermission('course.create'))
            {{--TODO render exam--}}
        <div class="row">
            <div class="col-12 pl-2 startexam" data-course_id="{{ $course->id }}" data-api="{{Auth::user()->api_token}}"/>
        </div>
        ...
        @else
            <div class="col-12 pl-2">
                ...
                @if($course->startExam == null)
                    <div class="row">
                        <div class="col-12 pl-2">
                            <a href="{{ route('startExam.create', ['course_id' => $course->id]) }}" class="btn btn-danger mt-3 mb-3">Maak
                                eerst een
                                starttoets aan!</a>
                        </div>
                    </div>
