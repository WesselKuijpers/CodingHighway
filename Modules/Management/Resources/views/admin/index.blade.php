...
@section('content')
    ...
    <form action="/management/admin/" method="get">
        <div class="row">
            <input type="text" name="query" placeholder="Vul een naam of email in" class="form-control col-md-3">
            <input type="submit" value="Zoek" class="btn btn-primary btn-organisation offset-1">
        </div>
    </form>
